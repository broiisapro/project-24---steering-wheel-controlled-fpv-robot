...
import edu.wpi.first.wpilibj2.command.button.Wheel;
...
//  private static final int gear = Shifting.gear;
  // The robot's subsystems and commands are defined here...
  private final Drivetrain m_drivetrain = new Drivetrain();
  private final XRPOnBoardIO m_onboardIO = new XRPOnBoardIO();
  private final Shifting s_Shifting = new Shifting();

  // Assumes a gamepad plugged into channel 0
  private final Wheel m_controller = new Wheel(0);
  
  private final Trigger shiftUp = m_controller.rightBumper();
  private final Trigger shiftDown = m_controller.leftBumper();
